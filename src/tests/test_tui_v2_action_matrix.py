...
async def test_tui2_matrix_actions_palette_events_and_guards() -> None:
    ...
    async with app.run_test() as pilot:
        ...
        app._run_palette_command("semantic-disable now")
        app._run_palette_command("semantic-build now")
        app._run_palette_command("semantic-rebuild now")
        ...
        app._run_palette_command("search-mode keyword")
        app._run_palette_command("semantic-status")
        app._run_palette_command("semantic-search notes")
